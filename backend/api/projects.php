...
if ($method === 'POST') {
    ...
    if ($title === '') {
        json_error(400, 'Project title is required.');
    }
    ...
    try {
        ...
        if ($absoluteBookPath !== null && is_file($absoluteBookPath)) {
            @unlink($absoluteBookPath);
        }

        json_error(500, 'Could not create project.');
    }
